...
public class HostedMatchProvider implements BukkitExtraArgumentProvider<PGMHostedMatch> {
  @Override
  ...
  @NonNull
  @Override
  public PGMHostedMatch getObject(@NonNull CommandContext context) throws ArgumentProviderException {
