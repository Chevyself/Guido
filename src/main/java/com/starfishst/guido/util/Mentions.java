package com.starfishst.guido.util;
...
public class Mentions {
     ...
     */
    @NotNull
    public static <T extends IMentionable> List<String> getMentions(@NotNull Collection<T> mentionables) {
    ...
    /**
     * Get the mentions from a collection of mentionables in a pretty way. This will get the collection of mentions
     * and turn them into a pretty string using {@link Lots#pretty(Collection)}
     *
     * @param mentionables the mentionables to get the mentions from
     * @param <T> the type of mentionables
     * @return the mentions of the mentionables
