...
import com.starfishst.guido.api.events.data.RoleDataLoadedEvent;
 ...
 * own data
 */
public class GuidoRole extends Catchable implements RoleData {
  ...
  public GuidoRole(long id, long guildId, @NotNull Set<Permission> permissions) {
    ...
    new RoleDataLoadedEvent(this).call();
  }
  ...
  public void onRemove() {
    new RoleDataUnloadedEvent(this).call();
  }
}
