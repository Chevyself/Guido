...
public class ImmutableMinecraftTeamMember implements MinecraftMatchTeamMember {

  @NonNull @Getter private final UUID id;
  @NonNull @Getter private final TeamRole role;

  public ImmutableMinecraftTeamMember(@NonNull UUID id, @NonNull TeamRole role) {
    this.id = id;
    this.role = role;
  }
}
