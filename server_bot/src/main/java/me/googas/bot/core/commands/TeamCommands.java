...
public class TeamCommands {
  ...
  /**
   * Get two event teams from a voice channel. This will getId the channel where the sender executed
  ...
  /**
   * This will getId the number given of captains. From the text channel where the sender executed
   * the command it will return the number given of random people, obviously, if the number given is
   * higher than the people in the channel it will not be completed
   *
   * @param context the context of the command
   * @param sender the sender of the command
   * @param number the number of leaders to getId
