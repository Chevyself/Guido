...
public interface LinkableInfo  {
  ...
  default boolean compare(@NotNull LinkableDataType type, @NotNull ValuesMap identification) {
    if (this.getType() == type) {
      switch (type) {
        case DISCORD_GUILD:
          return this.getIdentification().getOr("id", Long.class, -1L).equals(identification.get("id", Long.class)) &&
                  this.getIdentification().getOr("guildId", Long.class, -1L).equals(identification.get("guildId", Long.class));
        case DISCORD:
          return this.getIdentification().getOr("id", Long.class, -1L).equals(identification.get("id", Long.class));
        case MINECRAFT:
          ...
          return this.getIdentification().getOr("uuid", String.class, "").equals(thatUuid) ||
                  this.getIdentification().getOr("nickname", String.class, "").equalsIgnoreCase(thatNickname);
        default:
