package me.googas.bungee.scheduler;
...
public class BungeeScheduler implements Scheduler {
  ...
  @Getter private final Set<ScheduledTask> scheduledTasks = new HashSet<>();
  @Getter private final Set<Task> tasks = new HashSet<>();
